...
const BLOG = {
  AUTHOR: 'yuan', // 作者
  BIO: '干🍚人，干🍚魂', // 作者简介
  LINK: 'https://yuan-love.site', // 网站地址
  KEYWORDS: '技术，分享，生活，记录', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '8d739671eb8e419e93e405b255221d25', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'yuanniey@163.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/yuannienie', // 你的github个人主页
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'This is Generated By NotionNext', // 站点描述，被notion中的页面描述覆盖
